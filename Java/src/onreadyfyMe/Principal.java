...
public class Principal {
	...
	public static void main(String[] args) {
		...
		imprimirVehiculosLujo(vehiculos);
	}

	// Para modificar rapidamente los datos de entrada dentro de la clase que los utilizara, en el main()
	static ArrayList<Vehiculo> agregaVehiculo() {
		...
		Vehiculo autoE = new AutoElectrico("Peugeot", "208", 250000.00, "5", "240V");
